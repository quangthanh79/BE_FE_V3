...
router.post('/get_user_friends', verify, async (req, res) => {
  ...
  if (!checkInput.checkIsInteger (page))
    return callRes(res, responseError.PARAMETER_TYPE_IS_INVALID, ': page');
  if (page < 0 || page == 0) return callRes(res, responseError.PARAMETER_VALUE_IS_INVALID, ': page');
